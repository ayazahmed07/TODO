    ...
    let todolist = await inquirer.prompt([
        {
            name: "todo",
            type: "list",
            message: await textanimation(chalk.blue.bold("\n\t Make your todo list.\n\t")),
            choices: [
                "Add todo item.",
                "Delete an item.",
                "Update an item.",
        ...
        while (condition) {
            let addtodoitem = await inquirer.prompt([
                ...
                },
                {
                    name: "secondquestion",
                    type: "confirm",
                    message: chalk.blueBright.bold("Would you like to add some more todos"),
                    default: "true",
                },
            ]);
        ...
        const eidttodo = await inquirer.prompt([
            {
                name: "edit",
                type: "list",
                message: await textanimation(chalk.red.bold("\tChose an item to edit\n")),
                choices: todo,
            },
            {
                name: "newitem",
        ...
        const deletetodo = await inquirer.prompt([
            {
                name: "delete",
                type: "list",
                message: await textanimation(chalk.red.bold("\n\t Chose an item to delete\n")),
                choices: todo,
            },
        ]);
